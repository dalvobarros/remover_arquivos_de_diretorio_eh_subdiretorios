...
class RemoverFile:
    ...
    def removerArqDiretorioEhSubDiretorio(diretorio_remocao, remocao):
        ...
        lista_remocao = ['implements', 'Track3D', 'Materials', 'CoverageHistory', 'Swaths', 'EventHistory', 'newField', 'origin', 'EventSummary']

        lista_remocao.extend(remocao)
        ...
        try:
            ...
            if os.path.exists(diretorio_remocao):
                ...
                print("Diretório não existente: {0}, Por gentileza informe outro".format(diretorio_remocao))
...
##incluir = ['dalvo', 'myeverton']
##
##RemoverFile.removerArqDiretorioEhSubDiretorio("C:\\temp\\teste\\Nova pasta", incluir)
